        ...
        <nav class="colorlib-nav" role="navigation">
            <div class="top-menu">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-6">
                            <div id="colorlib-logo"><a href="{{ asset('/trang-chu') }}"><img src="images/logo.png"
                                        alt="" style="width: 300px;height: 50px;"></a></div>
                        </div>
                        <div class="col-xs-6 offset-md-2 header-search box">
                            ...
                            <script type="text/javascript">
                                ...
                                $('input.typeahead').typeahead({
                                    ...
                                    highlighter: function(item, data) {
                                        ...
                                        html += '<img src="../uploads/' + data.image +
                                            '"/ height="75px;" width="75px;">';
                                        html += '</div>';
                                        html += '<div class="col-md-8 pl-0">';
                                        html += '<span>' + data.name + '</span>';
                                        html += '<p class="m-0">' + data.code + '</p>';
                                        html += '</div>';
                                        html += '</div>';
                                        return html;
                                    }
                    ...
                    <div class="col-md-12 text-right menu-1" style="padding-top: 10px ">
                        <ul>
                            ...
                            <li><a href="{{ route('cart') }}"><i class="icon-shopping-cart"></i> Giỏ hàng
                                    [{{ Cart::count() }}]</a></li>
                        </ul>
                    </div>
                </div>
